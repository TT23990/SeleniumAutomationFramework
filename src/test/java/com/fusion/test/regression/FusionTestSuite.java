...
import com.fusion.utilities.TestDataProvider;
...
import static com.fusion.pageobjects.BasePage.applicationData;
import static com.fusion.pageobjects.BasePage.outputData;

public class FusionTestSuite extends BaseTest {
...
//            dataProviderClass =com.moodys.pageobjects.sharedservices.TestDataProvider.class )
    public FusionTestSuite(LinkedHashMap<String, String> user) {
        profiles = user;
    }

    @BeforeClass
    public void beforeClass() {
        BasePage.profiles = profiles.get("Profiles");
    ...
    public void beforeMethod() {
        ...
        Assert.assertTrue(new LoginPage().fillOutLoginForm(profiles.get("Username"),
