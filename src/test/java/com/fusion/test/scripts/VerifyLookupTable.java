...
public class VerifyLookupTable extends CoreSuperHelper {
    ...
    public static void executeScript() {
        try {
            ...
            home.selectPegaMenu("Lookups");
            home.selectPegaMenu(getCellValue("Table"));
            LookupsAction lookups= new LookupsAction();
            Assert.assertTrue(lookups.verifyLookupTableName(getCellValue("Table")));
            Assert.assertTrue(lookups.selectLookupAction(getCellValue("Table")));
//            Assert.assertTrue(lookups.verifyLookupTableErrors());
            ...
            if(!strConfirmationID.contains("process")) {
