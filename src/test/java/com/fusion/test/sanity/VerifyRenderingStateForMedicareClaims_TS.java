...
public class VerifyRenderingStateForMedicareClaims_TS extends CoreSuperHelper {
	...
	@Test
	public void verifyRenderingState(){
		aTAFInitParams();
		initiateTestScript();
	}
	...
	public static void executeScript() {
		...
		try {
			if (getCellValue("Run_Flag").equalsIgnoreCase("Yes")) {
				...
				String strQuery = "SELECT claimnumber FROM fepsit_pegadata.fhps_claims_work " +
						"WHERE inputfilename='"+str837file+"'";
